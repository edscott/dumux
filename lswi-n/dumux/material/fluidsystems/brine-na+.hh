...
//    static constexpr int comp1Idx = 1;
    ...
    static const int numComponents = 2; // H2O, NaCation

    static constexpr int H2OIdx = comp0Idx; // 0
//    static constexpr int NaCationIdx = comp1Idx; // 1
    ...
    static std::string componentName(int compIdx)
    {
        switch (compIdx)
        {
            ...
            case NaCationIdx: return NaCation::name();
        };
    ...
    static Scalar molarMass(int compIdx)
    {
        ...
        case NaCationIdx:return NaCation::molarMass();
        };
        DUNE_THROW(Dune::InvalidStateException, "Invalid component index " << compIdx);
    }

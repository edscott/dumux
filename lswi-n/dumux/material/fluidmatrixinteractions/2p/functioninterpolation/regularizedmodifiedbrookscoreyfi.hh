 ...
 */
#ifndef REGULARIZED_MODIFIED_BROOKS_FUNCTION_INTERPOLATION_COREY_HH
#define REGULARIZED_MODIFIED_BROOKS_FUNCTION_INTERPOLATION_COREY_HH

#include "modifiedbrookscoreyfi.hh"
#include "regularizedmodifiedbrookscoreyfiparams.hh"
 ...
 * \see BrooksCorey
 */
template <class ScalarT, class ParamsT = RegularizedModifiedBrooksCoreyFIParams<ScalarT> >
class RegularizedModifiedBrooksCoreyFI
{
    using ModifiedBrooksCoreyFI = Dumux::ModifiedBrooksCoreyFI<ScalarT, ParamsT>;
...
public:
    ...
    static Scalar pc(const Params& params, Scalar swe)
    {
        ...
        if (swe <= sThres) {
            Scalar m = ModifiedBrooksCoreyFI::dpc_dswe(params, sThres);
            Scalar pcsweLow = ModifiedBrooksCoreyFI::pc(params, sThres);
            return pcsweLow + m*(swe - sThres);
        }
        else if (swe > 1.0) {
            Scalar m = ModifiedBrooksCoreyFI::dpc_dswe(params, 1.0);
            Scalar pcsweHigh = ModifiedBrooksCoreyFI::pc(params, 1.0);
            return pcsweHigh + m*(swe - 1.0);
        }

        // if the effective saturation is in an 'reasonable'
        // range, we use the real Brooks-Corey law...
        return ModifiedBrooksCoreyFI::pc(params, swe);
    }
    ...
    static Scalar sw(const Params& params, Scalar pc)
    {
        ...
        Scalar swe = ModifiedBrooksCoreyFI::sw(params, pc);
        ...
        return ModifiedBrooksCoreyFI::sw(params, pc);
    }
    ...
    static Scalar dpc_dswe(const Params &params, Scalar swe)
    {
        ...
        return ModifiedBrooksCoreyFI::dpc_dswe(params, swe);
    }
    ...
    static Scalar dswe_dpc(const Params &params, Scalar pc)
    {
        ...
        if (pc < 0)
            ...
            swe = ModifiedBrooksCoreyFI::sw(params, pc);
        ...
        return 1.0/ModifiedBrooksCoreyFI::dpc_dswe(params, swe);
    }
    ...
    static Scalar krw(const Params &params, Scalar swe)
    {
        ...
        else if (swe >= 1.0)
        {
          ...
          {
              return params.k0rw_HS();
          }
          const Scalar nS = (params.S()-params.LS())/(params.HS()-params.LS());
          return nS*params.k0rw_HS()+ (1-nS)*params.k0rw_LS();
          // return params.k0rw_HS();
        }
        return ModifiedBrooksCoreyFI::krw(params, swe);
    }
    ...
    static Scalar krn(const Params &params, Scalar swe)
    {
        ...
        else if (swe <= 0.0)
        {
          if (params.LS() == params.HS())
          {
              return params.k0rn_HS();
          }
          const Scalar nS = (params.S()-params.LS())/(params.HS()-params.LS());
          return nS*params.k0rn_HS()+ (1-nS)*params.k0rn_LS();
          // return params.k0rn_HS();
        }

        return ModifiedBrooksCoreyFI::krn(params, swe);
    }
};
}

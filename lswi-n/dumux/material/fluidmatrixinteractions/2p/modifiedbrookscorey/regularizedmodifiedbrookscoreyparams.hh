 ...
 */
#ifndef DUMUX_REGULARIZED_MODIFIED_BROOKS_COREY_PARAMS_HH
#define DUMUX_REGULARIZED_MODIFIED_BROOKS_COREY_PARAMS_HH
...
class RegularizedModifiedBrooksCoreyParams : public ModifiedBrooksCoreyParams<ScalarT>
{
    using ModifiedBrooksCoreyParams = Dumux::ModifiedBrooksCoreyParams<ScalarT>;

public:
    using Scalar = ScalarT;

    RegularizedModifiedBrooksCoreyParams()
        : ModifiedBrooksCoreyParams()
    {
        setThresholdSw(0.01);
    }

    RegularizedModifiedBrooksCoreyParams(Scalar pe, Scalar lambda)
        : ModifiedBrooksCoreyParams(pe, lambda)
    {
        setThresholdSw(0.01);
    }

 ...
 */
#ifndef REGULARIZED_MODIFIED_BROOKS_COREY_HH
#define REGULARIZED_MODIFIED_BROOKS_COREY_HH

#include "modifiedbrookscorey.hh"
#include "regularizedmodifiedbrookscoreyparams.hh"
 ...
 * \see BrooksCorey
 */
template <class ScalarT, class ParamsT = RegularizedModifiedBrooksCoreyParams<ScalarT> >
class RegularizedModifiedBrooksCorey
{
    using ModifiedBrooksCorey = Dumux::ModifiedBrooksCorey<ScalarT, ParamsT>;
...
public:
    ...
    static Scalar pc(const Params& params, Scalar swe)
    {
        ...
        if (swe <= sThres) {
            Scalar m = ModifiedBrooksCorey::dpc_dswe(params, sThres);
            Scalar pcsweLow = ModifiedBrooksCorey::pc(params, sThres);
            return pcsweLow + m*(swe - sThres);
        }
        else if (swe > 1.0) {
            Scalar m = ModifiedBrooksCorey::dpc_dswe(params, 1.0);
            Scalar pcsweHigh = ModifiedBrooksCorey::pc(params, 1.0);
            return pcsweHigh + m*(swe - 1.0);
        }

        // if the effective saturation is in an 'reasonable'
        // range, we use the real Brooks-Corey law...
        return ModifiedBrooksCorey::pc(params, swe);
    }
    ...
    static Scalar sw(const Params& params, Scalar pc)
    {
        ...
        Scalar swe = ModifiedBrooksCorey::sw(params, pc);
        ...
        return ModifiedBrooksCorey::sw(params, pc);
    }
    ...
    static Scalar dpc_dswe(const Params &params, Scalar swe)
    {
        ...
        return ModifiedBrooksCorey::dpc_dswe(params, swe);
    }
    ...
    static Scalar dswe_dpc(const Params &params, Scalar pc)
    {
        ...
        if (pc < 0)
            ...
            swe = ModifiedBrooksCorey::sw(params, pc);
        ...
        return 1.0/ModifiedBrooksCorey::dpc_dswe(params, swe);
    }
    ...
    static Scalar krw(const Params &params, Scalar swe)
    {
        ...
        return ModifiedBrooksCorey::krw(params, swe);
    }
    ...
    static Scalar krn(const Params &params, Scalar swe)
    {
        ...
        return ModifiedBrooksCorey::krn(params, swe);
    }
};
}

 ...
 *
 */
#ifndef DUMUX_MODIFIED_BROOKS_COREY_HH
#define DUMUX_MODIFIED_BROOKS_COREY_HH

#include <dumux/material/fluidmatrixinteractions/2p/brookscorey.hh>
#include "modifiedbrookscoreyparams.hh"
 ...
 */
template <class ScalarT, class ParamsT = ModifiedBrooksCoreyParams<ScalarT> >
class ModifiedBrooksCorey
{
public:
    ...
    {
      return BrooksCorey<ScalarT, ParamsT>::pc(params, swe);
    }
    ...
    {
        return BrooksCorey<ScalarT, ParamsT>::sw(params, pc);
    }
    ...
    // {
    //   return BrooksCorey<ScalarT, ParamsT>::pc();
    // }
    ...
    {
        return BrooksCorey<ScalarT, ParamsT>::dpc_dswe(params, swe);
    }
    ...
    {
        return BrooksCorey<ScalarT, ParamsT>::dswe_dpc(params, pc);;
    }
